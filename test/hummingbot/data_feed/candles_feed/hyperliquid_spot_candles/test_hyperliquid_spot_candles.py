...
class TestHyperliquidSpotC0andles(TestCandlesBase):
    ...
    def get_fetch_candles_data_mock(self):
        return [
            [1718895600.0, "7.8095", "7.8819", "7.7403", "7.765", "1746.14", 0.0, 267, 0.0, 0.0],
    ...
    def get_universe_data_mock():
        return {
            "universe": [
                ...
                {"tokens": [14, 0], "name": "@13", "index": 13, "isCanonical": False},
                {"tokens": [15, 0], "name": "@14", "index": 14, "isCanonical": False},
                {"tokens": [16, 0], "name": "@15", "index": 15, "isCanonical": False},
                {"tokens": [17, 0], "name": "@16", "index": 16, "isCanonical": False},
                {"tokens": [18, 0], "name": "@17", "index": 17, "isCanonical": False},
                {"tokens": [19, 0], "name": "@18", "index": 18, "isCanonical": False},
                {"tokens": [20, 0], "name": "@19", "index": 19, "isCanonical": False},
            ],
            "tokens": [
                {
                    "name": "USDC",
