...
class TestMexcPerpetualCandles(TestCandlesBase):
    ...
    def get_fetch_candles_data_mock(self):
        return [
            [1717632000, 3868.6, 3870, 3860.14, 3862.3, 851390, 32903657.9187, 0.0, 0.0, 0.0],
    ...
    def get_candles_rest_data_mock(self):
        return {
            ...
            "code": 0,
            "data": {
                "time": [1717632000, 1717635600, 1717639200, 1717642800],
                "open": [3868.6, 3862.3, 3864.04, 3871.27],
                "close": [3862.3, 3864.04, 3871.27, 3864.01],
                "high": [3870, 3873.61, 3881.99, 3876.18],
                "low": [3860.14, 3856.32, 3862.3, 3862.99],
                "vol": [851390, 705088, 608801, 484966],
                "amount": [32903657.9187, 27251412.0495, 23576631.8815, 18769321.3995],
                "realOpen": [3868.61, 3862.29, 3864.04, 3871.26],
                "realClose": [3862.3, 3864.04, 3871.27, 3864.01],
                "realHigh": [3870, 3873.61, 3881.99, 3876.18],
                "realLow": [3860.14, 3856.32, 3862.3, 3862.99],
            },
        }
