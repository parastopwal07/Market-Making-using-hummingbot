...
class ParrotConnectorUnitTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.campaigns_get_resp = {
            ...
            "campaigns": [
                {
                    "id": 1,
                    "campaign_name": "zilliqa",
                    "link": "https://zilliqa.com/index.html",
                    "markets": [
                        {
                            "market_id": 1,
                            ...
                            "base_asset": "ZIL",
                            "quote_asset": "USDT",
                            "base_asset_full_name": "zilliqa",
                            "quote_asset_full_name": "tether",
                            "trading_pair": "ZILUSDT",
                            "return": 1.4600818845692998,
                            "last_snapshot_ts": 1592263560000,
                            "last_snapshot_volume": 7294.967867187001,
                            "trailing_1h_volume": 525955.48182515,
                            "hourly_payout_usd": 1.488095238095238,
                            "bots": 10,
                            "last_hour_bots": 14,
                            "filled_24h_volume": 0.0,
        ...
        self.expected_campaign_no_markets = parrot.CampaignSummary(
            market_id=1,
            ...
            active_bots=0,
            reward_per_wk=Decimal("0"),
            apy=Decimal("0"),
        )
        self.expected_campaign_w_markets = parrot.CampaignSummary(
            market_id=1,
            trading_pair="ZIL-USDT",
            exchange_name="binance",
            spread_max=Decimal("0.02"),
            payout_asset="ZIL",
            liquidity=Decimal("0"),
            liquidity_usd=Decimal("0"),
            active_bots=15,
            reward_per_wk=Decimal("205930.0"),
            apy=Decimal("0"),
        )
        self.expected_campaign_32_markets = {
            32: parrot.CampaignSummary(
                market_id=32,
                trading_pair="ALGO-USDT",
                exchange_name="binance",
                spread_max=Decimal("0.015"),
                payout_asset="ALGO",
                liquidity=Decimal("0"),
                liquidity_usd=Decimal("0"),
                active_bots=18,
            ...
            "markets": [
                {
                    ...
                    "active_bounty_periods": [
                        {
                            "bounty_period_id": 2396,
                            "bounty_campaign_id": 38,
                            "bounty_campaign_name": "dafi",
                            "bounty_campaign_link": "https://zilliqa.com/index.html",
                            "start_timestamp": 1657584000000,
                            "end_timestamp": 1658188800000,
                            "budget": {"bid": 102965.0, "ask": 102965.0},
                            "spread_max": 2.0,
                            "payout_asset": "ZIL",
                        }
                    ],
                    "return": 8.694721275945772,
                    "last_snapshot_ts": 1657812180000,
                    "last_snapshot_volume": 3678.5291375,
                    "trailing_1h_volume": 261185.66037849995,
                    "hourly_payout_usd": 4.317788244047619,
                    "bots": 15,
                    "last_hour_bots": 18,
                    "filled_24h_volume": 6816.23476,
                    "weekly_reward_in_usd": 751.8118232323908,
                    "weekly_reward": {"ZIL": 205735.9191468253},
                    "has_user_bots": "false",
                    "market_24h_usd_volume": 0.0,
                }
            ],
        ...
        self.snapshot_get_resp = {
            ...
            "market_snapshot": {
                ...
                "payout_summary": {
                    "open_volume": {
                        "reward": {"ask": {"ALGO": 0.01691468253968254}, "bid": {"ALGO": 0.01691468253968254}},
                        "reward_profoma": {"ask": {"ALGO": 0.01691468253968254}, "bid": {"ALGO": 0.01691468253968254}},
                        "payout_asset_usd_rate": {"ALGO": 0.30415},
        ...
        self.expected_snapshots_bad_timestamp = {
            "status": "error",
        ...
        self.expected_summary = {
            "ALGO-USDT": parrot.CampaignSummary(
                ...
                liquidity_usd=Decimal("12839.69224999999898390035113"),
                active_bots=17,
                reward_per_wk=Decimal("341.0"),
    ...
    def test_get_active_campaigns_empty_markets(self, mocked_http):
        ...
        self.assertTrue(
            self._is_logged("WARNING", "Could not get active markets from Hummingbot API" " (returned response '').")
        )
    ...
    def test_get_active_campaigns_failed_markets(self, mocked_http):
        ...
        self.assertTrue(
            self._is_logged(
                "WARNING", "Could not get active markets from Hummingbot API" f" (returned response '{self.get_fail}')."
            )
        )
    ...
    def test_retrieve_active_campaigns_error_is_logged(self, mock_api):
        ...
        self.assertTrue(
            self._is_logged(
                "WARNING", "Could not get active campaigns from Hummingbot API" f" (returned response '{resp}')."
            )
        )
