...
class TestDerivePerpetualAPIUserStreamDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    @patch(
        "hummingbot.connector.derivative.derive_perpetual.derive_perpetual_api_user_stream_data_source.DerivePerpetualAPIUserStreamDataSource._time"
    )
    ...
    async def test_listen_for_user_stream_subscribes_to_orders_and_balances_events(
        self, mock_utc_now, mock_timestamp, mock_auth, ws_connect_mock
    ):
        ...
        result_subscribe_orders = {
            ...
            "direction": "buy",
            "label": "0x6d72c6b30f6411655c91d8023e8f3126",  # noqa: mock
            "quote_id": None,
            "creation_timestamp": 1737806900308,
            "last_update_timestamp": 1737806948556,
            "limit_price": "1.6474",
            "amount": "20",
            "filled_amount": "0",
            "average_price": "0",
        ...
        result_subscribe_trades = {
            ...
            "instrument_name": "BTC-PERP",
            "direction": "buy",
            "label": "0xa483d0f3c4c2f38ca0a7f2ad280042d9",  # noqa: mock
            "quote_id": None,
        ...
        self.mocking_assistant.add_websocket_aiohttp_message(
            websocket_mock=ws_connect_mock.return_value, message=json.dumps(result_subscribe_login)
        )
        self.mocking_assistant.add_websocket_aiohttp_message(
        ...
        self.mocking_assistant.add_websocket_aiohttp_message(
            websocket_mock=ws_connect_mock.return_value, message=json.dumps(result_subscribe_collaterals)
        )
        self.mocking_assistant.add_websocket_aiohttp_message(
