...
class InjectiveV2APIOrderBookDataSourceTests(TestCase):
    ...
    def test_get_new_order_book_successful(self):
        ...
        order_book_snapshot = {
            "buys": [(Decimal("9487") * Decimal(f"1e{quote_decimals}"), Decimal("336241"), 1640001112223)],
            "sells": [(Decimal("9487.5") * Decimal(f"1e{quote_decimals}"), Decimal("522147"), 1640001112224)],
            "sequence": 512,
    ...
    def test_listen_for_order_book_diffs_successful(self, _):
        ...
        ) * Decimal(f"1e{-quote_decimals-18}")
    ...
    def test_get_funding_info(self):
        ...
        funding_info: FundingInfo = self.async_run_with_timeout(self.data_source.get_funding_info(self.trading_pair))
