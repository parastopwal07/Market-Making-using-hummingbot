...
class GridStrikeConfig(ControllerConfigBase):
    ...
    grid_ranges: List[GridRange] = Field(
        default=[
            GridRange(
                id="R0", start_price=Decimal("40000"), end_price=Decimal("60000"), total_amount_pct=Decimal("0.1")
            )
        ],
    ...
    min_spread_between_orders: Optional[Decimal] = Field(default=None, client_data=ClientFieldData(is_updatable=True))
